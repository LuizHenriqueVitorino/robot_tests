...
Listar o produto cadastrado
    ...
    ${preco_integer}=    Convert To Integer    155
    Dictionary Should Contain Item    ${RESPONSE.json()}    preco       ${preco_integer}
    Dictionary Should Contain Item    ${RESPONSE.json()}    descricao   meu produto de teste
    ${quantidade_integer}=    Convert To Integer    10
    Dictionary Should Contain Item    ${RESPONSE.json()}    quantidade  ${quantidade_integer}
